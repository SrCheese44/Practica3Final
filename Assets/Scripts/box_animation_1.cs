...
public class box_animation_1 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        submenu_1 = root.Query<Button>("submenu_1");
        submenu_2 = root.Query<Button>("submenu_2");
        ...
        submenu_1.clicked += () => JuegoReal();
        submenu_2.clicked += () => JuegoReal();
        submenu_3.clicked += () => JuegoReal();
